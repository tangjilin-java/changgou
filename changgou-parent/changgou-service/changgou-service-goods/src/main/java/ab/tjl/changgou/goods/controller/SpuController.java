...
import ab.tjl.changgou.goods.pojo.Goods;
import ab.tjl.changgou.goods.pojo.Spu;
...
public class SpuController {
    ...
    public Result<List<Goods>> findGoodsById(@PathVariable(value = "id") Long id){
        Goods goods = spuService.findGoodsById(id);
        return new Result<List<Goods>>(true,StatusCode.OK,"查询Goods成功！",goods);
    }
     ...
     */
    @PostMapping("/save")
    public Result<List<Goods>> save(@RequestBody Goods goods){
        spuService.saveGoods(goods);
        return new Result<List<Goods>>(true,StatusCode.OK,"增加商品成功！");
    }
